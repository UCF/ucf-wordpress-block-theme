...
<!--
Thank you for suggesting an idea to make the UCF WordPress Block Theme better.
...
Note: this theme keeps interactive, JavaScript-dependent components in a companion plugin. Please confirm your request belongs in the theme's style layer before submitting (see roadmap.md).
-->
